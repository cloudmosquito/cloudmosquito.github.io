...
![坐标系](四旋翼%20SO(3)%20姿态控制.assets/坐标系.png){.img-center width=50%}
...
![控制框图](四旋翼%20SO(3)%20姿态控制.assets/控制框图.png){.img-center width=80%}
...
![原始系统](./四旋翼%20SO(3)%20姿态控制.assets/原始系统.png){.img-center width=50%}

Simith 预估器的思想就是尽量消除反馈信号的延时，从而提升控制效果。也就是说，Smith 预估器想要达到的最佳效果如下：

![理想系统](./四旋翼%20SO(3)%20姿态控制.assets/理想系统.png){.img-center width=50%}
...
![Smith预估器系统](./四旋翼%20SO(3)%20姿态控制.assets/Smith预估器系统.png){.img-center width=50%}
