...
问题是，在已知一个策略 $\pi$ 的情况下，怎么获知该策略在状态 s 下的期望回报？
...
一方面，式 (1-4) 是一个过紧的条件，事实上可以放松成 $\max_{s} \left|\#\left\{V\right\} - V^{\pi}\right| \le \max_{s} \left|V-V^{\pi}\right|$ 。这个式子的意思是，只要我们能保证迭代过程中，误差最大项逐渐减小，就能说明所有误差项都有减小的趋势。如果误差最大项趋近于 0 ，那么所有误差项都必然趋近于 0 。参照以下示意图：

![](./基于动态规划的强化学习算法.assets/%E9%80%92%E5%87%8F%E7%A4%BA%E6%84%8F%E5%9B%BE.png){.img-center width=50%}
