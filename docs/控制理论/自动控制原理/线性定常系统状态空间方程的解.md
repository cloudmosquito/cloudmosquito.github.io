...
若 $A = \text{diag}\begin{bmatrix}\lambda_1 & \lambda_2 & \dots & \lambda_n\end{bmatrix}$ ，由上式可知 $e^{A} = \text{diag}\begin{bmatrix}e^{\lambda_1} & e^{\lambda_2} & \dots & e^{\lambda_n}\end{bmatrix}$ .

若 $A$ 有 n 个互异的特征值，必然可以进行相似对角化，有 $A = W\text{diag}\begin{bmatrix}\lambda_1 & \lambda_2 & \dots & \lambda_n\end{bmatrix}W^{-1}$ ，则 $e^{A} = W\text{diag}\begin{bmatrix}e^{\lambda_1} & e^{\lambda_2} & \dots & e^{\lambda_n}\end{bmatrix}W^{-1}$ .
...
若 $A = P^{-1}\text{diag}\begin{bmatrix}A_1 & A_2 & \dots & A_k\end{bmatrix}P$ ，则 $e^{A} = P^{-1}\text{diag}\begin{bmatrix}e^{A_1} & e^{A_2} & \dots & e^{A_k}\end{bmatrix}P$ .
