...
下文称“系统”，指的是如下线性时不变多输入多输出（LTI MIMO）系统：
...
我们称矩阵 $Q_c =\begin{bmatrix}B & AB & A^2B & \cdots & A^{n-1}B\end{bmatrix}$ 为能控性矩阵。系统 $(A,B)$ 能控 $\Longleftrightarrow$ 能控性矩阵行满秩。

## 能观性

见 “观测器” 中的 [系统能观性](../观测器/引言（系统能观性）.md) 一文。
