...
<figure markdown>
![](./陷波器说明.assets/拉氏变换表.png){width=100%}
<!-- <figcaption>拉氏变换表</figcaption> -->
</figure>
...
<figure markdown>
![](./陷波器说明.assets/幅频响应曲线.png){width=100%}
<!-- <figcaption>幅频响应曲线</figcaption> -->
</figure>
...
> 
> IIR 滤波器有发散的风险，需要保证极点（分母多项式 = 0时的 z）都在复平面的单位圆内部。
...
<figure markdown>
![](./陷波器说明.assets/实验结果.png){width=100%}
...
<figure markdown>
![](./陷波器说明.assets/MATLAB滤波器设计.png){width=100%}
<!-- <figcaption>MATLAB滤波器设计</figcaption> -->
</figure>
